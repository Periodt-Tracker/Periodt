...
![Image displaying the timeline of the menstrual cycle. Days 1 to 14 are the follicular phase, while 14 to 28 are the luteal phase. In the beginning of the follicular phase there is menstruation. Around day 14 is ovulation, and there is a fertile window about 4 days before and 1 day after ovulation. ](../../assets/blog/understanding_your_period/menstrual-cycle-timeline.png)
...
![Diagram of the uterus annotated with key biological features, including the uterus, fallopian tube, ovaries, uterine lining (endometrium), uterine wall, cervix and vagina](../../assets/blog/understanding_your_period/labelled-uterus-diagram.png)

Understanding your period becomes a bit easier when you understand what is happening inside of your body. 

![Diagram including 3 key visual stages a uterus goes through along the course of a menstrual cycle. We can begin at when the uterine lining is thin, and gets thicker during the follicular and luteal stage (diagram 3). At menstruation (diagram 2, showing bleeding from the uterus going through the cervix into the vagina), the uterine lining is shed until a thin layer remains (diagram 1 again).](../../assets/blog/understanding_your_period/uterus-stages-diagram.png)
...
![Diagram of the uterus during menstruation. This displays how the uterine lining is shed, the cervix dilates slightly and makes a joke about there being a lot of blood during a period. There are 2 extra text boxes, one explaining that on average, only 2-4 tablespoons of blood are lost per cycle, and the other textbox explains how not all the uterine lining is shed during your period, and a very thin 'basal layer' remains.](../../assets/blog/understanding_your_period/menstruation-diagram.png)
...
![Diagram explaining the key events in the follicular stage of a menstrual cycle. The uterine lining is rebuilt after it has been shed in menstruation, and an egg cell matures within a follicle in one of the two ovaries. There is an additional textbox explaining how fertilised eggs bind to the uterine lining, and that to grow, the embryo relies on nutrients found in the uterine lining. Therefore, for the embryo to have access to enough nutrients, the uterine lining must be thick.](../../assets/blog/understanding_your_period/follicular-diagram.png)
...
![Diagram explaining the key events during ovulation. It displays the egg cell (ovum) leaving the follicle and the ovary, then travelling through the fallopian tube into the uterus. There is an extra text box outlining how the egg cell can be fertilised by sperm cells, which then creates an embryo, which can grow into a fetus.](../../assets/blog/understanding_your_period/ovulation-diagram.png)
...
![Diagram explaining the key events of the luteal phase. Here, the uterine lining gets even thicker to support a potential embryo implanting. There is an extra text box ](../../assets/blog/understanding_your_period/luteal-diagram.png)
