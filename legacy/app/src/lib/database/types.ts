...
} from "../utilities/observer";
import type { row_update_type, sqlite_synchronous } from "./constants";

export type SqliteSynchronous =
	(typeof sqlite_synchronous)[keyof typeof sqlite_synchronous];
...
export interface DatabaseGetUtilities {
...
export interface LockContext extends DatabaseGetUtilities {
...
export type RowUpdateType =
	(typeof row_update_type)[keyof typeof row_update_type];
...
export interface DatabaseAdapter
	extends BaseObserverInterface<DBAdapterListener>,
		DatabaseGetUtilities {
...
export function extractTableUpdates(
	update: BatchedUpdateNotification | UpdateNotification,
) {
