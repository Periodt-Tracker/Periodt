...
const DropdownMenu: Component<DropdownMenuPrimitive.DropdownMenuRootProps> = (
	...
	return <DropdownMenuPrimitive.Root gutter={8} {...props} />;
};
...
const DropdownMenuShortcut: Component<ComponentProps<"span">> = (props) => {
	...
	return (
		<span
			class={merge("ml-auto text-xs tracking-widest opacity-60", props.class)}
			{...rest}
		/>
	);
};
...
const DropdownMenuSeparator = <T extends ValidComponent = "hr">(
	...
	return (
		<DropdownMenuPrimitive.Separator
			class={merge("-mx-1 my-1 h-px bg-muted", props.class)}
			{...rest}
		/>
	);
};
